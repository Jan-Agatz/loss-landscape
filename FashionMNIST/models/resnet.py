...
class WResNet_FashionMNIST(nn.Module):
    def __init__(self, block, num_blocks, k, num_classes=10):
        super(WResNet_FashionMNIST, self).__init__()
        self.in_planes = 16*k
...
def ResNet20():
    depth = 20
    n = (depth - 2) // 6
    return ResNet_FashionMNIST(BasicBlock, [n,n,n])

def ResNet20_noshort():
    depth = 20
    n = (depth - 2) // 6
    return ResNet_FashionMNIST(BasicBlock_noshortcut, [n,n,n])
...
def WRN56_2():
    depth = 56
    n = (depth - 2) // 6
    return WResNet_FashionMNIST(BasicBlock, [n,n,n], 2)

def WRN56_4():
    depth = 56
    n = (depth - 2) // 6
    return WResNet_FashionMNIST(BasicBlock, [n,n,n], 4)

def WRN56_8():
    depth = 56
    n = (depth - 2) // 6
    return WResNet_FashionMNIST(BasicBlock, [n,n,n], 8)

def WRN56_2_noshort():
    depth = 56
    n = (depth - 2) // 6
    return WResNet_FashionMNIST(BasicBlock_noshortcut, [n,n,n], 2)

def WRN56_4_noshort():
    depth = 56
    n = (depth - 2) // 6
    return WResNet_FashionMNIST(BasicBlock_noshortcut, [n,n,n], 4)

def WRN56_8_noshort():
    depth = 56
    n = (depth - 2) // 6
    return WResNet_FashionMNIST(BasicBlock_noshortcut, [n,n,n], 8)
